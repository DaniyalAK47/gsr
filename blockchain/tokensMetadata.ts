...
export const tokens: TokenConfig[] = [
  {
    ...
    color: "#0B9F74",
    background:
      "linear-gradient(143.13deg, #0B9F74 12.24%, #64DFBB 85.9%) #FFFFFF",
  ...
  },
  {
    ...
    color: "#0B91DD",
    background:
      "linear-gradient(143.37deg, #00A3FF 15.97%, #0B91DD 81.1%), #FFFFFF",
  ...
  },
  {
    ...
    color: "#1AAB9B",
    background:
      "linear-gradient(133.41deg, #1AAB9B 17.25%, #22CAB7 86.54%), #FFFFFF",
    bannerIcon: staticFilesRuntimeUrl("/static/img/tokens/maker_eth.png"),
    bannerGif: staticFilesRuntimeUrl("/static/img/tokens/MAKER_ETH.gif"),
    tags: [],
    protocol: "maker",
  ...
  },
  {
    ...
    color: "#667FE3",
    background:
      "linear-gradient(160.47deg, #F0F3FD 0.35%, #FCF0FD 99.18%), #FFFFFF",
    bannerIcon: staticFilesRuntimeUrl("/static/img/tokens/maker_eth.png"),
    bannerGif: staticFilesRuntimeUrl("/static/img/tokens/MAKER_ETH.gif"),
    tags: [],
    protocol: "maker",
  ...
  },
  {
    ...
    color: "#838489",
    background:
      "linear-gradient(160.47deg, #F1F5F5 0.35%, #E5E7E8 99.18%), #FFFFFF",
  ...
  },
  {
    ...
    background:
      "linear-gradient(160.26deg, #FFEAEA 5.25%, #FFF5EA 100%), #FFFFFF",
  ...
  },
  {
    ...
    background:
      "linear-gradient(160.47deg, #E0E8F5 0.35%, #F0FBFD 99.18%), #FFFFFF",
  ...
  },
  {
    ...
    background:
      "linear-gradient(160.47deg, #F0F3FD 0.35%, #FCF0FD 99.18%), #FFFFFF",
    bannerIcon: staticFilesRuntimeUrl(
      "/static/img/tokens/uni_old_usdc_eth.png"
    ),
  ...
  },
  {
    ...
    background:
      "linear-gradient(160.47deg, #E0E8F5 0.35%, #F0FBFD 99.18%), #FFFFFF",
    bannerIcon: staticFilesRuntimeUrl(
      "/static/img/tokens/uni_old_dai_usdc.png"
    ),
  ...
  },
  {
    ...
    background:
      "linear-gradient(160.47deg, #F0F3FD 0.35%, #FCF0FD 99.18%), #FFFFFF",
    bannerIcon: staticFilesRuntimeUrl(
      "/static/img/tokens/uni_old_wbtc_dai.png"
    ),
  ...
  },
  {
    ...
    color: "#E2F7F9",
    background:
      "linear-gradient(160.47deg, #E2F7F9 0.35%, #D3F3F5 99.18%), #000000",
